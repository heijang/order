...
public class OrderItemOptionGroup extends AbstractEntity {
    ...
    public OrderItemOptionGroup(OrderItem orderItem, Integer ordering, String itemOptionGroupName) {
        if (orderItem == null) throw new InvalidParamException("orderItem is null");
        if (ordering == null) throw new InvalidParamException("ordering is null");
        if (StringUtils.isEmpty(itemOptionGroupName)) throw new InvalidParamException("itemOptionGroupName is null");
