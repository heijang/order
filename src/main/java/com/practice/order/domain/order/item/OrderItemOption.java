...
public class OrderItemOption extends AbstractEntity {
    ...
    public OrderItemOption(OrderItemOptionGroup orderItemOptionGroup, Integer ordering, String itemOptionName, Long itemOptionPrice) {
        if (orderItemOptionGroup == null) throw new InvalidParamException("orderItemOptionGroup is null");
        if (ordering == null) throw new InvalidParamException("ordering is null");
        if (StringUtils.isEmpty(itemOptionName)) throw new InvalidParamException("itemOptionName is null");
        if (itemOptionPrice == null) throw new InvalidParamException("itemOptionPrice is null");
